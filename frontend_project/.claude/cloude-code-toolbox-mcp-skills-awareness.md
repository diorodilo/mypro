...
_Generated: 2026-05-04T09:26:39.816Z_
...
Workspace `mcp.json` _(folder: frontend_project)_

- **c:\mugisha_odilo_national_practical_exam_2025\frontend_project\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\L5SWD\AppData\Roaming\Code\User\mcp.json** — _File missing_
